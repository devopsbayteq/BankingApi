...
/// <summary>Manages account transactions / movements.</summary>
[ApiController]
...
public class TransactionsController : ControllerBase
{
    ...
    /// <summary>Retrieves a paginated list of transactions for a specific account.</summary>
    ...
    /// <param name="toDate">Filter transactions up to this date (UTC, ISO 8601).</param>
        ...
        [FromQuery] string? type = null)
    {
        ...
        var result = await _service.GetTransactionsAsync(accountId, page, pageSize, from, toDate, type);
        return Ok(result);
    }
